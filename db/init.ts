...
const organizations: OrganizationSeed[] = [
  {
    id: "org-atlas",
    slug: "atlas-colocation",
    name: "Atlas Colocation",
    type: "DATA_CENTER_OPERATOR",
    contactEmail: "security@atlas-colo.example",
  },
  {
    id: "org-northstar",
  ...
  {
    id: "org-brightway",
    slug: "brightway-facility-care",
    name: "Brightway Facility Care",
...
const zones: ZoneSeed[] = [
  ...
  },
  {
    id: "zone-mantrap",
    code: "SEC-MAN-01",
    name: "Data Hall Mantrap",
    category: "SECURITY",
    location: "Building 1 · Level 1",
    securityTier: 3,
    description: "Two-door controlled transition into the data halls.",
    sortOrder: 40,
  },
  {
  ...
  },
  {
    ...
    location: "Building 1 · Level 1",
    securityTier: 3,
    description: "Tenant hall containing Customer Cages 111 and 112.",
    sortOrder: 60,
  },
  {
    id: "zone-colo-hall-b",
    ...
    location: "Building 1 · Level 1",
    securityTier: 3,
    description: "Tenant hall containing Customer Cages 113 and 114.",
    sortOrder: 70,
  },
  {
    id: "zone-cage-111",
    code: "CAGE-111",
    name: "Customer Cage 111",
    category: "CUSTOMER_CAGE",
    location: "Data Hall A",
    securityTier: 4,
    description: "Dedicated Northstar Analytics colocation cage.",
    sortOrder: 111,
  },
  {
    id: "zone-cage-112",
    code: "CAGE-112",
    name: "Customer Cage 112",
    category: "CUSTOMER_CAGE",
    location: "Data Hall A",
    securityTier: 4,
    description: "Dedicated Lumina Commerce colocation cage.",
    sortOrder: 112,
  },
  {
    id: "zone-cage-113",
    code: "CAGE-113",
    name: "Customer Cage 113",
    category: "CUSTOMER_CAGE",
    location: "Data Hall B",
    securityTier: 4,
    description: "Dedicated Redwood Biotech colocation cage.",
    sortOrder: 113,
  },
  {
    id: "zone-cage-114",
    code: "CAGE-114",
    name: "Customer Cage 114",
    category: "CUSTOMER_CAGE",
    location: "Data Hall B",
    securityTier: 4,
    description: "Dedicated customer colocation cage.",
    sortOrder: 114,
  },
  {
    id: "zone-ups-a",
...
const profiles: ProfileSeed[] = [
  {
    ...
    key: "customer-cage-111",
    name: "Customer · Cage 111",
    description: "Common-area path and Cage 111 access for a colocated customer.",
  ...
  },
  {
    ...
    description: "Full facility operations access for an Atlas duty engineer.",
...
const people: PersonSeed[] = [
  {
    ...
    firstName: "Amara",
    lastName: "Okafor",
    email: "amara.okafor@atlas-colo.example",
...
const assignments = [
  ["assignment-amara-engineer", "person-amara-okafor", "profile-engineer-critical", "Atlas duty engineer access"],
  ["assignment-eli-cage-111", "person-eli-mercer", "profile-customer-cage-111", "Northstar Cage 111 authorization"],
...
export function getDatabase(): D1Database {
  if (!env.DB) {
    throw new Error(
      "The Atlas database is unavailable because the D1 binding `DB` is not configured.",
    );
  }
  return env.DB;
}
  ...
  const seededEvents = [
    {
      ...
      zoneId: "zone-cage-111",
      assignmentId: "assignment-eli-cage-111",
      profileId: "profile-customer-cage-111",
      decision: "GRANTED",
      reasonCode: "PROFILE_RULE_MATCH",
      explanation: "Customer · Cage 111 permits access to Customer Cage 111.",
      minutesAgo: 8,
    },
    {
      id: "event-seed-002",
      personId: "person-eli-mercer",
      zoneId: "zone-cage-112",
      assignmentId: null,
      profileId: null,
      decision: "DENIED",
      reasonCode: "ZONE_NOT_PERMITTED",
      explanation: "Active access exists, but none of its profiles permits Customer Cage 112.",
      minutesAgo: 21,
    },
    {
      id: "event-seed-003",
